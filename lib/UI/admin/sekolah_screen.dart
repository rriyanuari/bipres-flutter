...
class SekolahScreen extends StatefulWidget {
  @override
  State<SekolahScreen> createState() => _SekolahnState();
}

class _SekolahnState extends State<SekolahScreen> {
  bool loading = true;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          Get.toNamed(RouteName.sekolah_add_screen);
        },
        backgroundColor: Color(0xfff009c3d),
